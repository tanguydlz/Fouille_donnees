...
#Ce qui entraéne des inexactitudes dans les performances résultantes. Pour faire face é ces problémes, ROSE nous aide é générer des données de maniére synthétique également. 
...
#Nous constatons que notre précision se maintient é ~ 0,89 et montre que nos prévisions ne souffrent pas d'une variance élevée.
